...
p256_sswu_nu = BasicH2CSuite("P256-XMD:SHA.256-SSWU-NU-",p256_sswu_def._replace(is_ro=False))
p256_svdw_nu = BasicH2CSuite("P256-XMD:SHA.256-SVDW-NU-",p256_svdw_def._replace(is_ro=False))
